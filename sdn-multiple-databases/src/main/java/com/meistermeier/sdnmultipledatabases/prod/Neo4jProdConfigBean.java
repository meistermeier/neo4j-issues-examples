 ...
 */
@Configuration
@EnableNeo4jRepositories(basePackages = "com.meistermeier.sdnmultipledatabases.prod", neo4jTemplateRef = "prodTemplate")
...
//    }
    ...
    @Bean("prodTemplate")
    public Neo4jTemplate prodTemplate(@Qualifier("neo4jClient1") Neo4jClient client, Neo4jMappingContext mappingContext, Neo4jTransactionManager transactionManager) {
